...
import MernData from '../../../assets/data/CourseData/MernData'
  ...
  return (
    <div className="overflow-hidden">
      <Hero
        ...
        subtitle={MernData.subtitle}
        subtitle1={MernData.subtitle1}
        videoSrc=""
        poster={MernData.poster}
      />
      <Card
        title1={MernData.Cardtitle}
        subtitle={MernData.subtitle}
        subtitle1={MernData.subtitle1}
        benefits={MernData.benefits}
      />
      <InfoCard
       title1={MernData.infoCardtitle}
       subtitle={MernData.infoCardsubtitle}
       subtitle1={MernData.infoCardsubtitle1}
       benefits={MernData.infobenefits}
       />
      <Curriculum />
      <SliderCard />
      <Certification />
