...
const Curriculum: React.FC = (): JSX.Element => {
  ...
  const refs: Array<React.RefObject<HTMLDivElement>> = Array.from(
    ...
    <div className="py-16 p-2">
      ...
      <div className="flex py-10 max-lg:pl-0 max-md:pl-0 max-lg:justify-center gap-8 max-sm:gap-2 ">
        <div className="flex pl-[110px] max-lg:pl-0 max-md:pl-0 max-lg:justify-center gap-8 max-sm:gap-2 ">
          <div
            className={`border px-10 max-sm:px-3 py-2 rounded-xl cursor-pointer ${isActivePart(0)}`}
            onClick={() => {
              handleClick(0)
            }}
          >
          ...
          <div
            className={`border px-10 max-sm:px-3 py-2 rounded-xl cursor-pointer ${isActivePart(1)}`}
            onClick={() => {
              handleClick(1)
            }}
          >
          ...
          <div
            className={`border px-10 max-sm:px-3 py-2 rounded-xl cursor-pointer ${isActivePart(2)}`}
            onClick={() => {
              handleClick(2)
            }}
          >
          ...
          <div
            className={`border px-10 max-sm:px-3 py-2 rounded-xl cursor-pointer ${isActivePart(3)}`}
            onClick={() => {
              handleClick(3)
            }}
          >
        ...
        <div className="flex justify-center  gap-12 max-sm:gap-4 px-6 max-sm:px-0 max-lg:flex-col ">
          <div className=" flex flex-col gap-4 p-4 max-sm:p-0 max-xl:w-[400px]  w-[650px] max-lg:w-[740px] max-sm:w-[320px]">
            ...
            <div className=" text-white  flex justify-center">
              <p className=" max-sm:text-[16px] max-lg:text-center text-[#ABAEB2] max-sm:ml-3 max-sm:text-left max-lg: max-sm:pb-10 p-1">
          ...
          <div
            className="bg-[#121721]  rounded-2xl w-[630px] max-xl:w-[400px] max-lg:w-[700px] max-sm:w-[300px] flex flex-col max-sm:ml-3 max-lg:ml-4 px-4 max-sm:px-4   overflow-y-auto  scrollbar scrollbar-thumb-[#246BFD] scrollbar-track-white "
            style={{
              scrollbarWidth: 'thin',
              overflowY: 'auto',
