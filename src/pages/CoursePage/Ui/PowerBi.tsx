...
import PowerBiData from '../../../assets/data/CourseData/PowerBi'
...
const UI: React.FC<UiProps> = () => {
  ...
  return (
    <div className="overflow-hidden">
      <Hero
        title={PowerBiData.title}
        subtitle={PowerBiData.subtitle}
        subtitle1={PowerBiData.subtitle1}
        videoSrc=""
        poster={PowerBiData.poster}
      />
      <Card
        title1={PowerBiData.Cardtitle}
        subtitle={PowerBiData.subtitle}
        subtitle1={PowerBiData.subtitle1}
        benefits={PowerBiData.benefits}
      />
      <InfoCard
       title1={PowerBiData.infoCardtitle}
       subtitle={PowerBiData.infoCardsubtitle}
       subtitle1={PowerBiData.infoCardsubtitle1}
       benefits={PowerBiData.infobenefits}
       />
      <Curriculum />
      <SliderCard />
      <Certification />
