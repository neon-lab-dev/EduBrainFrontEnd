...
import PythonData from '../../../assets/data/CourseData/PythonData'
  ...
  return (
    <div className="overflow-hidden">
      <Hero
        ...
        subtitle={PythonData.subtitle}
        subtitle1={PythonData.subtitle1}
        videoSrc=""
        poster={PythonData.poster}
      />
      <Card
        title1={PythonData.Cardtitle}
        subtitle={PythonData.subtitle}
        subtitle1={PythonData.subtitle1}
        benefits={PythonData.benefits}
      />
      <InfoCard
       title1={PythonData.infoCardtitle}
       subtitle={PythonData.infoCardsubtitle}
       subtitle1={PythonData.infoCardsubtitle1}
       benefits={PythonData.infobenefits}
       />
      <Curriculum />
      <SliderCard />
      <Certification />
