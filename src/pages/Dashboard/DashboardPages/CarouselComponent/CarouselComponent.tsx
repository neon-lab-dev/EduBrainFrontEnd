...
const CarouselComponent = ({courseDetails, courseHeading, tabs}: CoursePageProps): JSX.Element => {
  ...
  const nextSlider = (): void => {
    setCurrentSlider((currentSlider) =>
      currentSlider === courseDetails.length - (isSmallScreen ? 1 : isMediumScreen ? 3 : 3)
        ? 0
        : currentSlider + 1
    );
  };
    ...
    return (
        ...
        <div className="mt-16">
            ...
            <div className="">
            <h1 className="text-[24px] text-neutral-10 font-semibold mb-4">{courseHeading}</h1>
