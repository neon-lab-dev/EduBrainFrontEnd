...
const DashboardSidebar = (): JSX.Element => {
  ...
  return (
    <div className="relative sidebar">
      ...
      <MdMenu onClick={toggleSidebar} className="text-neutral-10 cursor-pointer text-3xl"/>
      <div className={`fixed inset-y-0 left-0 z-50 bg-gray-800 w-64 h-screen transition-all duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        {isOpen && (
          <div className="menu bg-background w-[270px] p-5 h-full overflow-y-scroll">
            ...
            <div className="flex flex-col gap-6 mt-5">
              ...
              <button
                className="text-neutral-40 h-[45px] p-3 flex items-center gap-3 text-[16px] font-roboto font-normal transform transition-transform duration-300 hover:-translate-y-0.5"
              >
                <TbLogout2/> Logout
              </button>
            </div>
